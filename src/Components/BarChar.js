...
const BarChar = () => {
  ...
  return (
    <div className="bg">
     ...
     <MultiBar data={data[6]} month="Jul-" op=""/>
     <MultiBar data={data[1]} month="Aug-" op="0"/>
     <MultiBar data={data[3]} month="Sep-" op="0"/>
     <MultiBar data={data[5]} month="Oct-" op="0"/>
     <MultiBar data={data[2]} month="Nov-" op="0"/>
     <MultiBar data={data[4]} month="Dec-" op="0"/>
    </div>
  );
};
